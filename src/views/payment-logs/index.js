...
function PaymentLogs() {
  ...
  const [users, setUsers] = useState([
    { id: 1, user123: 'kuame3008', amount: '$19,623.00 USD', method: '•••• 4242' , plan: 'Monthly', status:"Pending" },
    { id: 2, user123: 'Jane Smith', amount: '$29,623.00 USD', method: '•••• 7542' , plan: 'Yearly', status:"Succeeded"  },
    { id: 3, user123: 'Bob Johnson', amount: '$39,623.00 USD', method: '•••• 9242' , plan: 'Monthly',  status:"Succeeded"},
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value, item, index) => (
        <Select
          className={value=="Pending" ? "color-yellow" : value=="Succeeded" ? "color-green" : value=="DELIEVRED" ? "color-green" : value=="DISPATCHED" ? "color-pink" : "#000"}
    ...
    <Layout className="configuration">
      <div className="boxDetails">
        ...
        <Row style={{ padding: 20, overflow: "auto" }}>
          <h5 className="pageTitle">My Apps</h5>
          {loading ? (
            <div
              style={{
                display: "flex",
