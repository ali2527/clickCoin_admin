...
function FeedbackManagement() {
  ...
  const [serviceProviders, setServiceProviders] = useState([
    { id: 1, name: 'Farrukh Haider', networth: '$19,623.00 USD', listedplaforms: '5', isActive: true },
    { id: 2, name: 'Raamish Lutfi', networth: '$29,623.00 USD', listedplaforms: '3', isActive: false },
    { id: 3, name: 'Sana Anjum', networth: '$12,623.00 USD', listedplaforms: '9', isActive: false },
  ...
  const columns = [
    ...
    {
      title: "Listed Plaforms",
      dataIndex: "listedplaforms",
      key: "listedplaforms",
    },
    {
      title: "Creation Date",
        ...
        <Row style={{textAlign:"end"}}>
          <Col md={24}>
            <Button
              ...
              onClick={() => navigate("/creators/creatorRequest")}
            >
              Creator Requests
            </Button>
          </Col>
